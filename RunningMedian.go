...
// RunningMedianFunc hackerrank func
...
// MinHeap Data structure for a minimum heap
type MinHeap []int
...
// Pop removes the top element from heap
...
// MaxHeap is maximum heap structure
type MaxHeap struct {
	MinHeap
}
...
// Less is compare op for heap
func (h MaxHeap) Less(i, j int) bool { return h.MinHeap[i] > h.MinHeap[j] }

// RunningMedian struct is for storing data and solution
