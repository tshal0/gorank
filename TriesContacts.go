...
// TriesContactsFunc is main lib func
...
// TrieLink is a link used in trie data struct
// Design a Trie.
...
// Trie is a struct with childnodes and links
type Trie struct {
	childNodes []*TrieLink
	stringEnd  bool
}

// NewTrie creates trie
func NewTrie() *Trie {
	return &Trie{stringEnd: true, childNodes: make([]*TrieLink, 0)}
}

// PrintTrie prints trie
...
// ExistsOrAdd checks for exist and adds
...
// FindPartial looks for partial substr
